...
import { createNotFoundError, createValidationError } from '@/api/utils/error-handler'
...
const updateTaskList =
  (client: IndexDBClient) =>
  async (id: string, data: UpdateTaskListInput): Promise<MutationTaskListResponse> => {
    const db = client || (await getDB())
