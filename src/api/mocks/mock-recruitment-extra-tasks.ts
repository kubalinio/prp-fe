...
const mockRecruitmentExtraTasks = () => {
  ...
  const tasks: Task[] = [
    ...
    // 3. Animations
    {
      ...
      description: 'Implement smooth animations when adding new tasks to the list',
      status: 'todo',
    ...
    // 5. UI Layout Switching
    {
      ...
      description: 'Create functionality to switch between list and card views for tasks',
      status: 'todo',
