...
const mockRecruitmentMainTasks = () => {
  ...
  const tasks: Task[] = [
    ...
    },
    {
      ...
      description: 'Create a task card displaying title, description, and status',
      status: 'done',
    ...
    },
    {
      ...
      description: 'Create edit button and reuse form component for editing existing tasks',
      status: 'done',
    ...
    // 3. Filtering and Sorting
    {
      ...
      description: 'Create search input to filter tasks by title and description text',
      status: 'done',
    ...
    },
    {
      ...
      description: 'Add controls to sort tasks by creation date in ascending or descending order',
      status: 'done',
    ...
    // 4. Task Deletion
    {
      ...
      description: 'Implement delete button on task cards with appropriate action',
      status: 'done',
    ...
    },
    {
      ...
      description: 'Add confirmation dialog before deleting tasks to prevent accidental deletion',
      status: 'done',
    ...
    // 5. Responsiveness
    {
      ...
      description: 'Create responsive layout for mobile devices with appropriate styling',
      status: 'done',
    ...
    },
    {
      ...
      description: 'Optimize layout for desktop with appropriate spacing and component sizing',
      status: 'done',
    ...
    },
    {
      ...
      description: 'Implement media queries to handle various screen sizes and orientations',
      status: 'done',
    ...
    },
    {
      ...
      description: 'Ensure UI works correctly across different devices and screen sizes',
      status: 'in-progress',
